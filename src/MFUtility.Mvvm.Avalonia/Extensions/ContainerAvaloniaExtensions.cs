...
namespace MFUtility.Mvvm.Avalonia.Extensions;

public static class ContainerAvaloniaExtensions {
	...
	public static Control ResolveView(this Container container, Type viewType) {
		var method = typeof(ContainerAvaloniaExtensions)
		             .GetMethod("ResolveView")
		             .MakeGenericMethod(viewType);
		return (Control)method.Invoke(null, new object[] { container })!;
	}
